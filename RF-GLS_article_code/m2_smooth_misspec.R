...
rf_estimation200_res <- mean((rfestimation200 - fxestimation200)^2, trim = 0.0)
...
rfgls_unknown_estimation200_res <- mean((rowMeans(sprf_res[[5]])[(length(fxtest200)+1):nrow(sprf_res[[5]])] - fxestimation200)^2, trim = 0.0)
...
rf_res_spatial <- mean((pred_ols - ytest200)^2)
rfgls_res_spatial <- mean((pred_gls - ytest200)^2)
